        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SucceededRows = table.Column<int>(type: "integer", nullable: true),
                    FailedRows = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataImports_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataImports_BusinessId_FileHash",
                table: "DataImports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_BusinessId_SaleDate",
                table: "Sales",
                columns: new[] { "BusinessId", "SaleDate" });
